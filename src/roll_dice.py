"""Inmplemenatation of the dice rolling."""
...
def draw_die(screen, center_x, center_y, value, size=100):
    ...
    if value is None:
        ...
        # Each pip is a small circle. We'll compute its position relative to the die
        # rectangle
        pip_radius = size // 10
...
def show_dice(dice_values):
    ...
    # Window size
    WIDTH, HEIGHT = 600, 400  # noqa: N806
    ...
    # Basic layout: 2 dice for the dealer on top row, 2 dice for the player on bottom
    # row.
